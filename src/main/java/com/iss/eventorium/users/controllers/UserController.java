...
public class UserController {
    ...
    public UserController() {
        ...
        accounts.add(new GetAccountDto(2L, "user2@example.com", "Jane", "Smith", "987654321", "Address 2", city, Role.EVENT_ORGANIZER));
        accounts.add(new GetAccountDto(3L, "admin@example.com", "Admin", "User", "555555555", "Admin Street", city, Role.ADMIN));
    }
